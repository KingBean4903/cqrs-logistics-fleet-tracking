...
const (
	RouteService_CreateRoute_FullMethodName  = "/route.RouteService/CreateRoute"
	RouteService_UpdateRoute_FullMethodName  = "/route.RouteService/UpdateRoute"
	RouteService_AssignDriver_FullMethodName = "/route.RouteService/AssignDriver"
)
...
type RouteServiceClient interface {
	...
	UpdateRoute(ctx context.Context, in *UpdatedRouteRequest, opts ...grpc.CallOption) (*UpdatedRouteResponse, error)
...
func (c *routeServiceClient) UpdateRoute(ctx context.Context, in *UpdatedRouteRequest, opts ...grpc.CallOption) (*UpdatedRouteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdatedRouteResponse)
...
func (c *routeServiceClient) AssignDriver(ctx context.Context, in *AssignDriverRequest, opts ...grpc.CallOption) (*AssignDriverResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssignDriverResponse)
	err := c.cc.Invoke(ctx, RouteService_AssignDriver_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RouteServiceServer interface {
	...
	UpdateRoute(context.Context, *UpdatedRouteRequest) (*UpdatedRouteResponse, error)
...
func (UnimplementedRouteServiceServer) UpdateRoute(context.Context, *UpdatedRouteRequest) (*UpdatedRouteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateRoute not implemented")
}
func (UnimplementedRouteServiceServer) AssignDriver(context.Context, *AssignDriverRequest) (*AssignDriverResponse, error) {
...
func _RouteService_UpdateRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteServiceServer).UpdateRoute(ctx, req.(*UpdatedRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RouteService_AssignDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignDriverRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouteServiceServer).AssignDriver(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RouteService_AssignDriver_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteServiceServer).AssignDriver(ctx, req.(*AssignDriverRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RouteService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RouteService_AssignDriver_Handler,
		},
	},
